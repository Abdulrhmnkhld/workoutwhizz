...
import 'package:projectattempt/whizchat.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                          '     Incline DB press               40 kg\n     Flat Machine press          95 kg',
                          style: TextStyle(
                            fontSize: 16,
                            color: Colors.white,
                          ),
      ...
      bottomNavigationBar: Container(
        height:
        120, // Adjust height to ensure enough space for shadow and larger circle
        decoration: BoxDecoration(
